...
1. **Подключение стандартных библиотек:**
   ...
   - `sstream` — для парсинга пользовательского ввода рёбер.
     ...
     <img src="https://i.ibb.co/f0wh4fH/FE09-B931-9-ED2-4017-BD29-D5-D71115-CD10.png" width="500" />
...
2. **Структура `Graph`:**
   ...
   - Содержит метод `addEdge()`, который добавляет неориентированные рёбра между вершинами \(u\) и \(v\).
     ...
     <img src="https://i.ibb.co/C0sKfT6/20-C43-D35-61-E0-49-B3-BA7-C-9-B46807-E9579.png" width="200" />
